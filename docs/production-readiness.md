...
| Engine integration | 90 | HTTP, WebSocket, mock engine, contract tests, production-parity OODA reports, and live risk-reducer endpoints exist. Real accepted canary evidence remains external. |
