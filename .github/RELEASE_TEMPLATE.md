...
- [ ] `scripts/homebrew_formula.py <downloaded-release-dir> --tag <tag> --output Formula/zero.rb` updates the committed formula.
- [ ] `scripts/homebrew_formula_check.py` passes.
...
- [ ] PyPI, crates.io, Docker Hub, and GHCR package registry publication remains disabled unless this release explicitly includes an ownership-proof section.
