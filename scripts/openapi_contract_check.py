...
REQUIRED_PATHS = {
    ...
    "/intelligence/model-gateway/health",
    "/intelligence/model-gateway/audit",
    "/intelligence/export",
    "/v1/intelligence/snapshots",
    "/v1/intelligence/history",
    "/v1/intelligence/cohorts",
    "/v1/intelligence/benchmarks",
    "/v1/intelligence/webhooks",
    "/v1/intelligence/exports",
    "/hl/account",
    "/hl/reconcile",
    "/hl/status",
    "/immune",
...
REQUIRED_SCHEMAS = {
    ...
    "GenesisSnapshotResponse",
    "EvolveSnapshotResponse",
    "ResearchSnapshotResponse",
    "RuntimeParityResponse",
    "MetricsResponse",
    "AuditExportResponse",
    ...
    "IntelligenceCommercialResponse",
    "ModelGatewayStatusResponse",
    "ModelGatewayHealthResponse",
    "ModelGatewayAuditResponse",
    "HostedIntelligenceResponse",
    "HostedIntelligenceWriteRequest",
    "HostedIntelligenceErrorResponse",
    "HyperliquidStatusResponse",
    "HyperliquidAccountResponse",
    "HyperliquidReconciliationResponse",
    "ImmuneResponse",
    "LiveCockpitResponse",
    "LiveCanaryPolicyResponse",
    "LiveCertificationResponse",
    "LiveExecutionReceiptsResponse",
...
FIXTURE_REQUIREMENTS = {
    ...
    "contracts/paper-api/genesis.json": {
        "schema": "GenesisSnapshotResponse",
        "keys": {
            "schema_version",
            "generated_at",
            "source",
            "mode",
            "applies_code_changes",
            "guardian_policy",
            "stats",
            "decisions",
            "privacy",
    ...
    "contracts/paper-api/evolve.json": {
        "schema": "EvolveSnapshotResponse",
        "keys": {
            "schema_version",
            "generated_at",
            "source",
    ...
    "contracts/paper-api/research.json": {
        "schema": "ResearchSnapshotResponse",
        "keys": {
            "schema_version",
            "generated_at",
            "source",
    ...
    "contracts/paper-api/runtime_parity.json": {
        "schema": "RuntimeParityResponse",
        "keys": {
            "schema_version",
            "generated_at",
            "source",
    ...
    "contracts/paper-api/decision_stack.json": {
        "schema": "DecisionStackResponse",
        "keys": {
            "schema_version",
            "mode",
            "paper_only",
    ...
    "contracts/intelligence/commercial.json": {
        "schema": "IntelligenceCommercialResponse",
        "keys": {
            "schema_version",
            "generated_at",
            "positioning",
    ...
    "contracts/intelligence/model_gateway_health.json": {
        "schema": "ModelGatewayHealthResponse",
        "keys": {
            "schema_version",
            "generated_at",
            "status",
    ...
    "contracts/intelligence/model_gateway_audit.json": {
        "schema": "ModelGatewayAuditResponse",
        "keys": {
            "schema_version",
            "generated_at",
            "status",
    ...
    "contracts/live/evidence.json": {
        "schema": "LiveEvidenceResponse",
        "keys": {
            "schema_version",
            "generated_at",
            "mode",
    ...
    "contracts/live/receipts.json": {
        "schema": "LiveExecutionReceiptsResponse",
        "keys": {
            "schema_version",
            "generated_at",
            "mode",
