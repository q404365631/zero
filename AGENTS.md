...
- `zero-mcp` exposes read-only paper, strategy, memory, genesis, research,
  decision-stack, evolve, position, and proof-pack inspection tools. It must
  not expose live execution or order placement.
