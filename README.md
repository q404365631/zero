...
| ZERO Evolution | Local memory, genesis proposals, guardian review, red-team, paper canaries, calibration, and evolve loops that let ZERO improve under review. | Memory and genesis open; remaining loop in progress |
...
| Self-evolution | Local memory and genesis proposal core exist now with redacted extraction, append-only journals, guardian classification, API readouts, and MCP snapshots. Builder/evolve, red-team, paper canary, calibration, and promotion gates remain planned public extraction. |
...
is now partially implemented: local memory and genesis proposal classification
exist, while builder/evolve, red-team, paper canary, calibration, and promotion
gates remain first-class public extraction targets. See
[Memory Core](docs/memory-core.md), [Genesis](docs/genesis.md), and
